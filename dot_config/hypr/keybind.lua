...
local KEY = {
	...
	POWER = ("%s + SHIFT + Q"):format(mainMod),
	...
	CLIPBOARD = ("%s + SHIFT + V"):format(mainMod),
...
hl.bind(KEY.POWER, hl.dsp.exec_cmd("noctalia msg panel-toggle session"), { description = "Power menu" })
...
hl.bind(KEY.CLIPBOARD, hl.dsp.exec_cmd("bash -c 'cliphist list | wofi --dmenu | cliphist decode | wl-copy'"), { description = "Clipboard history" })
